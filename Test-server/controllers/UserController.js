...
class UserController {
    ...
    async register(req, res) {
        try {
            ...
            return res.status(500).json({ message: 'Ошибка при регистрации: ' + error.message });
        }
    }
    ...
    async login(req, res) {
        try {
            ...
            return res.status(500).json({ message: 'Ошибка при входе: ' + error.message });
        }
    }
    ...
    async check(req, res) {
        try {
            ...
            return res.status(500).json({ message: 'Ошибка при проверке токена: ' + error.message });
        }
    }
}
